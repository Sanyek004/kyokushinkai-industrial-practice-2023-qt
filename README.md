Сделать двуязычный `README.md` — это отличная практика на GitHub. Обычно в самом начале делают «переключатель» языков (ссылки-якоря), а сам документ делят на две части: сначала идет английский (как международный стандарт IT), а ниже — русский.

Для красоты мы также добавим бейджи (иконки технологий).

Скопируйте этот текст и вставьте его в ваш файл `README.md`. 
